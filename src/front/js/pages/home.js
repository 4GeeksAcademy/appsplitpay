    ...
    <div className="home-content">
      <section className="p-5 d-flex align-items-center justify-content-center flex-column">
        <div className="text-center mb-3 mt-5 d-flex align-items-center justify-content-center flex-column">
          <h1
            className="mb-5 mt-5"
            style={{ fontSize: "64px", fontFamily: "Trebuchet MS" }}
          >
        ...
        <div
          className="w-100"
          style={{ height: "380px", fontFamily: "Trebuchet MS" }}
        >
          <img
        ...
        <div className="d-flex">
          <div>
            ...
            <h4 style={{ fontFamily: "Trebuchet MS" }}>
              Explicación breve del sistema y de las funciones que ofrece y el
              porqué el usuario debe utilizar nuestros servicios
            </h4>
          </div>
          <div className="p-3">
            <img
