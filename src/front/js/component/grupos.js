...
export const Grupos = () => {
    ...
    const handleSubmit = async () => {
        ...
        if (cleanedName === "" || memberIds.length === 0) {
        ...
        if (createdGroup) {
            ...
            alert(store.errorMessage || "Error al crear el grupo.");
        }
    };
                                ...
                                store.groups.map((group, index) => (
                                    <div className="contacto-lista-item" key={index}>
                                        ...
                                        <div className="contacto-info" >
                                            ...
                                            <button onClick={handleNavigateToEventoGrupal}>EventoGrupal</button>
                                            <button>EventoGrupal</button>
                                        </div>
