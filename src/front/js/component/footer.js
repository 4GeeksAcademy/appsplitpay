                ...
                <div className="container text-center text-md-start mt-5">
                    <div className="row mt-3">
                        <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                            ...
                            <p>
                                La mejor herramienta para dividir y gestionar tus gastos.
                                Mantén tus amistades intactas con cuentas claras y justas.
                            </p>
                        </div>
                        ...
                        <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p>
                                <a href="#!" className="text-reset">Ponen</a>
                            </p>
                            <p>
                                <a href="#!" className="text-reset">Vistas</a>
                            </p>
                            <p>
                                <a href="#!" className="text-reset">Aca</a>
                            </p>
                            <p>
                                <a href="#!" className="text-reset">Utiles</a>
                            </p>
                        </div>
