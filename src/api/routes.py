...
from api.models import db, User, TokenBlockedList, Contact, Payment, Event, Group, GroupMember
...
CORS(api)
#, origins=['*'], methods=['GET', 'POST', 'PUT', 'DELETE'], headers=['Content-Type', 'Authorization'])
